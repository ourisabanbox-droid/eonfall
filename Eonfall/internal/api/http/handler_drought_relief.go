...
func (h *Handler) PostDroughtReliefAction(w http.ResponseWriter, r *http.Request) {
	...
	var req DroughtReliefActionRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		http.Error(w, "invalid json body", http.StatusBadRequest)
		return
	}

	if err := ValidateDroughtReliefActionRequest(req); err != nil {
	...
	action := &world.WorldAction{
		...
		UserID:         req.UserID,
		ActionType:     world.ActionDroughtRelief,
